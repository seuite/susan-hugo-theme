...
[Demo](https://seuite.github.io/)

Here are some screen shots.

![Carousel](https://github.com/seuite/susan-hugo-theme/blob/master/images/screenshot.png)

![List](https://github.com/seuite/susan-hugo-theme/blob/master/images/screenshot2.png)

![Post](https://github.com/seuite/susan-hugo-theme/blob/master/images/screenshot3.png)
...
From the root of your Hugo site, clone the theme into `themes/Susan` by running:

```sh
# Clone theme into the themes/Susan directory
$ git clone https://github.com/seuite/susan-hugo-theme.git themes/Susan
```
...
Please see the sample [`config.toml`](https://github.com/seuite/susan-hugo-theme/blob/master/exampleSite/config.toml). The theme is built on Hugo v0.46.
...
slidesDirPath    = "themes/Susan/static/img/header-slides"  
...
By default, the series recommendation card list in the sidebar use `themes/Susan/static/img/default.png` as intro picture. You can set `name`, `img`, and `summary` in `data/series.toml`. `name` of the series should be in lower capitals. If the series cannot be found in `series.toml`, `default.png` will be used.
...
Licensed under the MIT License. See the [LICENSE](https://github.com/seuite/susan-hugo-theme/blob/master/LICENSE) file for more details.
...
* Hugo theme [AllinOne](https://github.com/orianna-zzo/AllinOne)
